...
class App extends Component {
  ...
  componentDidMount() {
    this.callBackendAPI()
      // .then(res => {
      //   res.Data ? this.setState({ data: res.Data, loading: false }) : this.setState({loading: true})
      // })
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1 className="tite">Error Injection</h1>
        <table className="data-out">
          ...
          {this.state.loading ? <div className="loading">
            <div className="dot-flashing"></div>
             ...
             : <button className="push-GAS" onClick={pushGAS}>Push to GAS</button>}
      </div>
    );
  }
}
